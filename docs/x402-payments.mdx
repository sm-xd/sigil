...
<Note>
Twelve real paid requests have settled in total — some in HBAR, some in HTS USDC. The full list, with the exact `token_transfers` and fees, is in [EVIDENCE.md](https://github.com/sm-xd/sigil/blob/main/EVIDENCE.md).
</Note>
...
<Frame caption="The 'Use this skill' section: the live paywall, the licence holders, and the payments ledger.">
  <img src="/docs/img/skill-access.png" alt="Use this skill section with the 402 paywall" />
</Frame>
