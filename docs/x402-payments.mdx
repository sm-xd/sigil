...
<Frame caption="One paid request: the 402, the signed transfer, Blocky402 settling it, and the licence NFT minted at the end.">
  <img src="/docs/img/diagram-x402-sequence.png" alt="x402 payment sequence between the agent, the gateway and Blocky402" />
</Frame>
