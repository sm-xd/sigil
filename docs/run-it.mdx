...
This runs the full cycle: seed a claim with staked USDC on Arc, then have the agent discover it, pay, probe it in the sandbox, dispute the violation, and settle on-chain.
