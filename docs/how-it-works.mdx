...
<Frame caption="How a claim lives and dies. Replace this with your generated diagram (see the prompt in the repo).">
  <img src="/img/diagram-claim-lifecycle.png" alt="The five-step claim lifecycle" />
</Frame>
