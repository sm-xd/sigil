...
```mermaid
flowchart TB
  A["1 · Claim<br/>stake USDC on Arc"] --> B["2 · Consume<br/>agent pays x402 on Hedera"]
  B --> C["3 · Probe<br/>deterministic sandbox"]
  C --> D["4 · Dispute<br/>bond + trace on-chain"]
  D --> E["5 · Settle<br/>verifier re-runs, money moves"]
```
