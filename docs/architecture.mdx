...
<Frame caption="The system at a glance. Replace this with your generated diagram (see the prompt in the repo).">
  <img src="/img/diagram-architecture.png" alt="Sigil system architecture" />
</Frame>
